hls: hls.o string_manip.o power_subset.o polynomial.o
	g++ hls.o string_manip.o power_subset.o polynomial.o -o hls -std=c++11 -I/opt/homebrew/Cellar/gmp/6.3.0/include/ -lgmp -lgmpxx
